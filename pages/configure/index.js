    ...
    <>
      <Container maxWidth='md'>
        ...
        <Typography paragraph>
          ...
          be a hostname and not an ip address due to ssl needs, but an ip
          address will technically work to get the server started.
        </Typography>
        ...
        <Typography paragraph>
          These ports specify the port number to bind the LeGo server to. This
          is both the API backend as well as the frontend (if the backend is
        ...
        <Typography paragraph>
          ...
          propagation when using a dns challenge solving method. Only a
          primary_ip is necessary but if a particular provider has a secondary
